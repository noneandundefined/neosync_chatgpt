...
-- View для bar-виджета «Популярные конфигурации» на странице аналитики.
-- Берёт актуальные профили из configurations_prof, считает число датчиков
-- и раскладывает записи по bucket-колонкам для группировки в SQL виджета.
